...
func (_m *SignalEmitter) EXPECT() *SignalEmitter_Expecter {
	return &SignalEmitter_Expecter{mock: &_m.Mock}
}
...
func (_e *SignalEmitter_Expecter) DispatchSignal(signal interface{}) *SignalEmitter_DispatchSignal_Call {
	return &SignalEmitter_DispatchSignal_Call{Call: _e.mock.On("DispatchSignal", signal)}
}
...
func (_e *SignalEmitter_Expecter) Free() *SignalEmitter_Free_Call {
	return &SignalEmitter_Free_Call{Call: _e.mock.On("Free")}
}
...
func (_e *SignalEmitter_Expecter) GetObjectPath() *SignalEmitter_GetObjectPath_Call {
	return &SignalEmitter_GetObjectPath_Call{Call: _e.mock.On("GetObjectPath")}
}
...
// NewSignalEmitter creates a new instance of SignalEmitter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
